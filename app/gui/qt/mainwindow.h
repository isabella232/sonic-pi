...
public:
#if defined(Q_OS_MAC)
    MainWindow(QApplication &ref, bool i18n, QMainWindow* splash, std::string load_file = "");
#else
    MainWindow(QApplication &ref, bool i18n, QSplashScreen* splash, std::string load_file = "");
#endif
...
private:
    ...
    static bool sendOSC(oscpkt::Message m);
